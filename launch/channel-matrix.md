...
10. Add AgenticSkills, OpenSpace, and Uneed as second-wave channels, and check
    for passive Toolify indexing only after ClawHub is live.
11. Revisit Dev Hunt only after its current authoritative submission path is
    confirmed.
