...
`business`, `revenue`, `research`, `validation`, `human-in-the-loop`,
`open-source`

## Links required

- Public source repository.
- Landing page if the form provides a separate product URL.
...
Curated directory search, categories, and individual skill pages. Do not assign
traffic expectations until referral data exists.
