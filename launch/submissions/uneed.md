...
- Confirmed public landing page and GitHub repository.
...
Use the closest current equivalents of:
`AI`, `Productivity`, `Open Source`, `Developer Tools`, `Business`.

## Links required

- Landing page as the primary product URL.
- GitHub as the source/download link.

## Assets required

- Square logo.
- Main social card.
- Persona/router image.
- Optional clean install screenshot.

## Expected discovery mechanism

Launch-day homepage, rolling daily/weekly/monthly/yearly leaderboards,
persistent product page, and possible newsletter placement for high-performing
products.
